...
<script lang="babel">
    ...
    export default {
                ...
                this.$http({
                    ...
                    if (response.data.code === '00000') {
                        ...
                        if (!this.tempBool) {
                            ...
                            console.log(this.formData.provinceId);
                ...
                this.$http({
                    ...
                    if (response.data.code === '00000') {
                        ...
                        if (!this.tempBool) {
                            ...
                            console.log(this.formData.cityId);
            ...
            handleEditAddress(e) {
                ...
                if (this.formValidate !== true) {
                    ...
                    this.$http({
                        ...
                        if (response.data.code === '00000') {
                            this.$message('编辑成功');
                            this.$router.replace('/person/myDeliveryAddress');
                        }
                    }).catch((response) => {
                        console.log(response);
                    });
        ...
        mounted() {
            ...
            } else if (!Object.prototype.hasOwnProperty.call(this.$route.query, 'addressId')) {
                this.$router.replace('/person/myDeliveryAddress');
            } else {
                // 获取地址信息
                this.$http({
