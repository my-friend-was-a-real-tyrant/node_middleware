...
<template>
    <div class="myDeliveryAddress-wrapper" v-title="'收货地址'">
        <ul class="myDeliveryAddress-list">
            <li class="myDeliveryAddress-list-item" v-for="(item, index) in addressList" :key="item.id">
                ...
                <div class="myDeliveryAddress-list-item-operate">
                    <div class="myDeliveryAddress-list-item-operate-frequently">
                        <zdCheckbox
                            ...
                            @click="handleSetFrequentlyAddress(item.id)"></zdCheckbox>
                    ...
                    <div class="myDeliveryAddress-list-item-operate-button">
                        <zdButton
                            ...
                            @click="handleDelDeliveryAddress(item.id, index)"
                        >删除</zdButton>
                        <zdButton
                            size="small"
                            type="primary"
                            :disabled="item.roomId ? false : true"
                            @click="handleEditDeliveryAddress(item.id)"
                        >编辑</zdButton>
                    </div>
                </div>
            </li>
    ...
    export default {
        ...
        methods: {
            ...
            handleAddDeliveryAddress() {
                this.$router.push('/person/myDeliveryAddress/addDeliveryAddress');
            },
