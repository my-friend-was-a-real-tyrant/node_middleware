<style lang="less" scoped>
    .apply{
        ...
        &-form{ flex-grow: 1; margin-top: 1rem;
    ...
    <div class="apply-wrapper">
        ...
        <div class="apply-form">
            ...
            <zdInput
                ...
                v-show="formData.identity.value !== '1'"
            ></zdInput>
            <p class="apply-link" @click="handleInvite">
                <span>我有邀请码 ></span>
            </p>
            <zdButton @click="handleSubmit">确定</zdButton>
        </div>
        <p class="apply-visitor" v-if="isVisitor === true" @click="handleRouteToSystem">
            <span>我先看看</span>
        </p>
    </div>
</template>
<script lang="babel">
    ...
    export default {
        ...
        methods: {
            ...
            handleInvite() {
                this.$router.push('/person/myFamily/addHouse/invite');
            }
        },
        created() {
            if (this.address === '') {
        ...
        mounted() {
            if (!this.isVisitor) {
                this.formData.myName = this.info.userName
            }
        }
    }
</script>