<template>
    <div class="contain-main">
        ...
        <el-table stripe :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="managerName" label="管理员姓名" width="150"></el-table-column>
            <el-table-column prop="managerCellphone" label="管理员手机号" width="150"></el-table-column>
...
<script lang="babel">
    ...
    export default {
        ...
        methods: {
            ...
            ajaxFun() {
                this.$http({
                    url: '/api/manageSystem/system/manager/logs/getLogsList',
                    params: {
            ...
            handleSizeChange(val) {
                ...
                if(this.$route.query.currentPage){
                    this.$router.push({
                        path: '/manageSystem/manager/logs'
                    });
                } else {
                    this.$router.push({
                        path: '/manageSystem/manager/logs',
